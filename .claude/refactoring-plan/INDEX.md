...
| ID     | Title                                                                                     | Phase | Status | Team Analysis |
| ------ | ----------------------------------------------------------------------------------------- | ----- | ------ | ------------- |
| P0-0   | Remove/guard example & dev-example routes in production                                   | 0     | `todo` | Non-Critical  |
| P0-1   | Fix NODE_ENV in Dockerfile                                                                | 0     | `todo` | Non-Critical  |
...
| P0-27  | Add `NOTICE` file — Apache 2.0 Section 4(d) attribution requirement                       | 0     | `todo` | Non-Critical  |
