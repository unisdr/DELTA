...
- [App UI Translations](app-ui/index.md)
  Static interface text (e.g., buttons, labels, messages, emails).
- [Content Translations (HIPs, Sectors, Assets)](content/index.md)
  Localized seeded content from the database.

## Translation Format

- [Translation File Format](file-format.md)
  Structure of the JSON translation files, supported fields, and format details.

## Language Handling

- [Language Resolution & Propagation in Code](language-param.md)
...
- [Basic Translation Usage](examples.md)
