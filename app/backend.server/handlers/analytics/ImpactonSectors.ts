...
export const getImpactOnSector = async (ctx: BackendContext, countryAccountsId: string, sectorId: string, filters?: Filters, currency?: any): Promise<SectorImpactResponse> => {
	try {
		// Input validation
		if (!sectorId) {
			return {
