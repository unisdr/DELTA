...
export const disasterRecordsTable = pgTable(
  'disaster_records',
  {
    ...
    originatorRecorderInst: text('originator_recorder_inst').notNull().default(''),
...
export const disasterRecordsRel = relations(disasterRecordsTable, ({ one, many }) => ({
  countryAccount: one(countryAccounts, {
...
////////////////////////////////////////////////////////////////
export const sectorType = pgTable('sector_type', {
  id: ourRandomUUID(),
  name: text('name'),
  description: text('description'),
});

export type SelectSectorType = typeof sectorType.$inferSelect;
export type InsertSectorType = typeof sectorType.$inferInsert;

////////////////////////////////////////////////////////////////
export const subSector = pgTable('sub_sector', {
  id: ourRandomUUID(),
  name: text('name'),
  description: text('description'),
});

export type SelectSubSector = typeof subSector.$inferSelect;
export type InsertSubSector = typeof subSector.$inferInsert;
