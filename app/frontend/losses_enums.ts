	...
	return [
		{
			...
			label: "Increase in expenditure, Infrastructure temporary",
			type: "infrastructure_temporary",
		},
		{
			key: "decrease_in_revenues_infrastructure_temporary",
			label: "Decrease in revenues, Infrastructure temporary",
			type: "infrastructure_temporary",
		},
		{
			key: "cost_for_service_or_production_continuity_incurred_but_not_assessed",
			label:
				"Cost for service or production continuity incurred but not assessed",
			type: "infrastructure_temporary",
		},
...

		{
			...
			label:
				"Increase in expenditure for Production, Service delivery and availability",
		...
		},
		{
			...
			label:
				"Decrease in revenues due to drop on Production, Service delivery and availability",
			type: "production_service_delivery_and_availability",
		},
		{
			key: "access_difficultied",
			label: "Access difficulted",
			type: "production_service_delivery_and_availability",
		},
		{
			key: "availability_decreased",
			label: "Availability decreased",
			type: "production_service_delivery_and_availability",
		},
		// Governance and decision-making
		{
			key: "increase_in_expenditure_governance",
			label: "Increase in expenditure, Governance",
			type: "governance_and_decision_making",
		},
		{
			key: "decrease_in_revenue_governance",
			label: "Decrease in revenue, Governance",
			type: "governance_and_decision_making",
		},
		{
			key: "governance_processes_difficulted",
			label: "Governance processes difficulted",
			type: "governance_and_decision_making",
		},
		...
		// Risk and vulnerabilities
		{
			...
			label: "Increase in expenditure to address risk and vulnerabilities",
			type: "risk_and_vulnerabilities",
		},
		{
			key: "decrease_in_revenue_from_risk_protection",
			label: "Decrease in revenue from risk protection",
			type: "risk_and_vulnerabilities",
		},
		{
			key: "risks_and_vulnerabilities_increased",
			label: "Risks and vulnerabilities increased",
			type: "risk_and_vulnerabilities",
		},
		...
		},
		{
			...
			label: "Non quantified - other losses",
			type: "other_losses",
		},
...
export function typeEnumAgriculture() {
	return [
		...
		},
		{
			...
			label: "# of workers who loss their jobs permanently",
			type: "employment_and_livelihoods_losses",
		},
		{
			key: "number_of_persons_whose_livelihoods_related_to_sector_lost",
