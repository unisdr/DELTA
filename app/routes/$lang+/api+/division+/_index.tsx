...
GET /en/api/division/list?page=1&pageSize=100

Delete all divisions
POST /en/api/division/delete_all

Upload divisions zip
POST /api/division/upload
Example
curl -H "X-Auth:$DTS_KEY" -F "file=@example_divisions.zip" 'http://localhost:3000/en/api/division/upload'
