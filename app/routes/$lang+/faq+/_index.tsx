...
const groups: Group[] = [
        ...
        sections: [
            {
                ...
                image: "/assets/images/faq/how_is_delta_different_from_desinventar.jpg",
            },
            {
    ...
    {
        title: "About the software system",
        sections: [
            {
                                    ...
                                    return (
                                        <div key={section.title}>
                                            <Accordion className="rounded-xl bg-white shadow-[0_6px_22px_rgba(15,23,42,0.06)] ring-1 ring-slate-200/70">
                                                <AccordionTab
                                                    header={`Question ${questionNumber}: ${section.title}`}
                                                >
